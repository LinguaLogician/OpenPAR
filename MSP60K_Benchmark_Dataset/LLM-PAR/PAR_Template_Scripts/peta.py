...
def generate_data_description(save_dir):
    ...
    """
    peta_data = loadmat("/data/liangtao/DataSets/PAR_Dataset/PETA/PETA.mat")
    dataset = EasyDict()
    ...
    # breakpoint()
    sentences = {
        dataset.image_name[i]: simple_complete_sentences[i]
        for i in range(len(simple_complete_sentences))
    }
...
if __name__ == "__main__":
    save_dir = "/data/liangtao/DataSets/PAR_Dataset/PETA/"
